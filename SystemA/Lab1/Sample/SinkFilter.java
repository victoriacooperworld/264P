...
//					System.out.print(new_time+ ','  + new_velocity+',' +new_altitude+','+new_pressure+',' + new_tem);
					line.add(outputCSV(TimeStampFormat.format(TimeStamp.getTime()),velocity,altitude,pressure,temperature));
				}
