...
//				System.out.println(id);
				...
				if ( id == 4 )
				{
					...
					String strAltitude = String.format("%3.5f", altitude);
					if(wildjump == (byte) 1){  //wildjump happens
						strAltitude+='*';
					}
					wildjump=(byte)0;
					String data = TimeStampFormat.format(TimeStamp.getTime()) +','+String.format("%3.5f", velocity)+','+ strAltitude +','+String.format("%3.5f", pressure)+','+String.format("%3.5f", temperature)+'\n';
					lines.add(data);
				}
	...
	public static void writeCSV(List<String> line) {
		try (PrintWriter writer = new PrintWriter("outputA.csv")) {
